...
amount_row(_("Price:"), 'price', null,'', get_supplier_currency($selected_id), $dec2, true);
...
amount_row(_("Conversion Factor (to our UOM):"), 'conversion_factor', null, null, null, 'max', true);
