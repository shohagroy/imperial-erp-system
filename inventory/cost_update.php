...
amount_row(_("Unit cost"), "material_cost", null, "class='tableheader2'", null, $dec1, true);

if ($myrow && $myrow["mb_flag"]=='M')
{
	amount_row(_("Standard Labour Cost Per Unit"), "labour_cost", null, "class='tableheader2'", null, $dec2, true);
	amount_row(_("Standard Overhead Cost Per Unit"), "overhead_cost", null, "class='tableheader2'", null, $dec3, true);
}
else
{
