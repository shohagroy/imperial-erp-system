...
function defaultCompany()
{
	...
	if (!$login_timeout) { // FA logo
    	echo "<a target='_blank' href='".$SysPrefs->power_url."'><img src='$path_to_root/themes/$def_theme/images/logo_frontaccounting.png' alt='FrontAccounting' height='50' onload='fixPNG(this)' border='0' style='padding-top:5%;padding-bottom: 10%;'></a>";
	} else { 
		echo "<h2 style='font-weight:300; '>"._('Authorization Timeout')."</h2>";
	} 
	echo "</td>\n";
	end_row();
	...
	echo "<tr> <td colspan='2'> <center> <input type='submit' value='&nbsp;&nbsp;"._("Login")."&nbsp;&nbsp;' name='SubmitUser'"
		." onclick='set_fullmode();'".(isset($blocked_msg) ? " disabled" : '')." > </center> </td></tr>\n";
	end_table(1);
	...
	echo "<td class='bottomBarCell' style='padding-left:3%;'>$date</td>\n";
	
	echo "<td><a target='_blank' href='".$SysPrefs->power_url."' tabindex='-1' style='float:right; padding-right:3%;'>".$SysPrefs->app_title." $version  Build ".$SysPrefs->build_version." - " . _("Theme:") . " " . $def_theme . "</a></td>\n";
