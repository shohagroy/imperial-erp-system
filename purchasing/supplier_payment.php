...
start_form();
	...
	start_outer_table(TABLESTYLE2, "", 5);
	...
	{
		amount_row(_("Bank Amount:"), 'bank_amount', null, '', $bank_currency, null, true);
	}
	...
	amount_row(_("Amount of Discount:"), 'discount', null, '', $supplier_currency, null, true);
	amount_row(_("Amount of Payment:"), 'amount', null, '', $supplier_currency, null, true);
