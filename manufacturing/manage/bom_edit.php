...
start_row();
stock_manufactured_items_list_cells(_("Select a manufacturable item:"), 'stock_id', null, false, true, false, true);
end_row();
...
//	hidden('stock_id', $selected_parent);
	...
	locations_list_row(_("Location to Draw From:"), 'loc_code', null, false, false, false, true);
