...
else
{
	...
	locations_list_row(_("Destination Location:"), 'StockLocation', null, false, false, false, true);
}
...
{
    qty_row(_("Quantity Required:"), 'quantity', null, null, null, $dec, true);
    if ($_POST['released'])
...
else
{
	...
	amount_row($wo_cost_types[WO_LABOUR], 'Labour', null, null, null, null,true);
	gl_all_accounts_list_row(_("Credit Labour Account"), 'cr_lab_acc', null);
	amount_row($wo_cost_types[WO_OVERHEAD], 'Costs', null, null, null, null, true);
