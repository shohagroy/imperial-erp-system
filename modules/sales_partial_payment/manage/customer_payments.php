...
if (!isset($_POST['bank_account'])) {
	...
	if (isset($_GET['SInvoice'])) {
		...
		$dflt_act = get_sales_point(user_pos());
		$_POST['bank_account'] = $dflt_act['pos_account'];
		if ($inv) {
...
if($_SESSION['wa_current_user']->can_access('SA_BANKCHANGE'))
	bank_accounts_list_row(_("Into Bank Account:"), 'bank_account', null, true);
else {
	label_row(_("Into Bank Account:"), $dflt_act['bank_account_name']);
	hidden('bank_account');
}
...
if($_SESSION['wa_current_user']->can_access('SA_DATECHANGE'))
	...
	label_row(_("Date of Deposit:"), $_POST['DateBanked']);
	hidden('DateBanked');
}
...
amount_row(_("Bank Charge:"), 'charge', null, '', $bank_currency, null, true);
...
amount_row(_("Amount of Discount:"), 'discount', null, '', $cust_currency, null, true);

amount_row(_("Amount:"), 'amount', null, '', $cust_currency, null, true);
