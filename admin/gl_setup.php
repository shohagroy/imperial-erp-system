...
amount_row(_("Default Credit Limit:"), 'default_credit_limit', $_POST['default_credit_limit'], null, null, null, true);
...
percent_row(_("Delivery Over-Receive Allowance:"), 'po_over_receive', null, true);

percent_row(_("Invoice Over-Charge Allowance:"), 'po_over_charge', null, true);
