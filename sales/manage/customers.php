...
function customer_settings($selected_id) 
{
	...
	amount_row(_("Credit Limit:"), 'credit_limit', $_POST['credit_limit'], null, null, null, true);
	...
	{
		table_section_title(_("Branch"));
		locations_list_row(_("Default Inventory Location:"), 'location', null, false, false, false, true);
