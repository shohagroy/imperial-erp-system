...
percent_row(_("Provision").':', 'provision', null, true);
amount_row(_("Turnover Break Pt Level:"), 'break_pt', null, null, null, null, true);
percent_row(_("Provision")." 2:", 'provision2', null, true);
end_table(1);
