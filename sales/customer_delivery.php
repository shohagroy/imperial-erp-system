...
date_cells(_("Date"), 'DispatchDate', '', $_SESSION['Items']->trans_no==0, 0, 0, 0, "class='tableheader2'", false, true);
end_row();
...
//---------
start_row();
date_cells(_("Invoice Dead-line"), 'due_date', '', null, 0, 0, 0, "class='tableheader2'", false, true);
end_row();
end_table();
...
policy_list_row(_("Action For Balance"), "bo_policy", null, true);
