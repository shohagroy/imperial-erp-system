...
if (!isset($path_to_root) || isset($_GET['path_to_root']) || isset($_POST['path_to_root']))
	...
	// Main Title
	$app_title = "Imperial Sanitary House";

	// Build for development purposes
	$build_version 	= date("d.m.Y", filemtime("$path_to_root/CHANGELOG.txt"));

	// Powered by
	$power_by 		= "Imperial Group";
	$power_url 		= "http://www.new.imperialsanitary.com";
	...
	// 	context help feed from imperialsanitary.com
	$help_base_url = 'http://imperialsanitary.com/fawiki/index.php?n=Help.';
	...
	$pagesizes 		= array("Letter", "A4","Customes");
