...
function defaultCompany()
{
	...
	echo "<link href='$path_to_root/themes/$def_theme/default.css' rel='stylesheet' type='text/css'> \n";
 	echo "<link href='$path_to_root/themes/default/images/logo.ico' rel='icon' type='image/x-icon'> \n";
	send_scripts();
	if (!$login_timeout)
	{
		echo $js;
	...
	if (!$login_timeout) { // FA logo
    	echo "<a target='_blank' href='".$SysPrefs->power_url."'><img src='$path_to_root/themes/$def_theme/images/logo_muhurta.png' alt='FrontAccounting' height='50' onload='fixPNG(this)' border='0' ></a>";
	} else { 
