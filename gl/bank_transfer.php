...
function gl_payment_controls($trans_no)
{
	...
	{
		amount_row(_("Amount:"), 'amount', null, null, $from_currency, null, true);
		amount_row(_("Bank Charge:"), 'charge', null, null, $from_currency, null, true);

		amount_row(_("Incoming Amount:"), 'target_amount', null, '', $to_currency, 2, null, true);
	} 
	else 
	{
		amount_row(_("Amount:"), 'amount', null, null, null, null, true);
		amount_row(_("Bank Charge:"), 'charge', null, null, null, null, true);
	}
