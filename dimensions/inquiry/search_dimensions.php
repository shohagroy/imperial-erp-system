...
number_list_cells('', 'type_', null, 1, 2, _("All Types"));
date_cells(_("From:"), 'FromDate', '', null, 0, 0, -5);
date_cells(_("To:"), 'ToDate');

check_cells( _("Only Overdue:"), 'OverdueOnly', null, false, false, 'nowrap');

if (!$outstanding_only)
{
   	check_cells( _("Only Open:"), 'OpenOnly', null, false, false, 'nowrap');
}
else
	$_POST['OpenOnly'] = 1;
